...
import Item from './Item'; // import ItemGroup from './ItemGroup'
...
export default class Items extends Component {
  ...
  render() {
    ...
    return /*#__PURE__*/React.createElement("div", {
      className: "rct-items"
    }, visibleItems.filter(item => sortedDimensionItems[_get(item, itemIdKey)]).map(item => /*#__PURE__*/React.createElement(Item, {
