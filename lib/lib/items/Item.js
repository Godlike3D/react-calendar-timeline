...
export default class Item extends Component {
  ...
  constructor(_props) {
    ...
    _defineProperty(this, "getItemRef", el => this.item = el);

    _defineProperty(this, "getDragLeftRef", el => this.dragLeft = el);

    _defineProperty(this, "getDragRightRef", el => this.dragRight = el);

    _defineProperty(this, "getItemProps", (props = {}) => {
    ...
    _defineProperty(this, "getResizeProps", (props = {}) => {
    ...
    this.cacheDataFromProps(_props);
    this.state = {
  ...
  mountInteract() {
    ...
    }).styleCursor(false).on('dragstart', e => {
